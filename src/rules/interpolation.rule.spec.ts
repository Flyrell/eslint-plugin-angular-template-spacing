...
import { ruleName, ruleModule } from '@plugin/rules/interpolation.rule';
    ...
    describe('BoundText Listener', () => {
        ...
        describe.each([
            ...
            it.each([
                ...
                { interpolation: '<div>{{interpolation }}</div>', location: mockLocation([0, 0], [0, 29]), loc: mockLocation([0, 7], [0, 7]) },
                { interpolation: '<div>{{ interpolation}}</div>', location: mockLocation([0, 0], [0, 29]), loc: mockLocation([0, 21], [0, 21]) },
        ...
        describe('whitespace = never', () => {
            ...
            it.each([
                ...
                { interpolation: '<div>{{interpolation }}</div>', location: mockLocation([0, 0], [0, 29]), loc: mockLocation([0, 20], [0, 21]) },
                { interpolation: '<div>{{ interpolation}}</div>', location: mockLocation([0, 0], [0, 29]), loc: mockLocation([0, 7], [0, 8]) },
            ])('should create a report for interpolation with one incorrect side',
                ({ interpolation, location, loc }) => {
